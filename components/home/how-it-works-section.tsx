...
function StepItem({ icon, label, description }: Step) {
  return (
    <div
      className="relative p-6 rounded-2xl bg-white/5 backdrop-blur-xs border
    border-white/10 hover:border-rose-500/5 transition-colors group w-full"
    >
      ...
      <div className="flex flex-col flex-1 gap-1 justify-between">
        ...
        <h4 className="text-center text-gray-600 text-sm">{description}</h4>
      </div>
    </div>
  );
}
